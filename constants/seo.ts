...
export const SEO_CONFIG = {
  ...
  keywords: {
    en: [
      ...
      // Core Technology Keywords - User Requested
      'crane AI',
      'AI crane',
      'smart crane',
      'Hong Kong intelligent construction',
      'Hong Kong intelligent AI',
      'Hong Kong HKCRC',
      'HKCRC',
      'CRC crane',
...
export const generateArticleSchema = (article: {
  ...
  return {
    ...
    about: [
      ...
      { '@type': 'Thing', name: 'Crane AI' },
      { '@type': 'Thing', name: 'Smart Crane' },
      { '@type': 'Thing', name: 'Hong Kong Intelligent Construction' },
      { '@type': 'Organization', name: 'HKCRC' },
      { '@type': 'Organization', name: 'Hong Kong Centre for Construction Robotics' },
...
export const generateLocalBusinessSchema = () => {
  ...
  return {
    ...
    keywords: 'CraneR, CraneR HK, CraneR Technology, AI tower crane, crane AI, AI crane, smart crane, unmanned tower crane, intelligent construction, Hong Kong intelligent construction, HKCRC, Hong Kong HKCRC, Hong Kong construction tech, smart crane Hong Kong',
    knowsAbout: [
      'AI Tower Crane',
      'Crane AI',
      'AI Crane',
