...
import { Config, PostListItem } from "@/lib/api/public-read";
    ...
    switch (locale) {
      ...
      default:
        return {
          ...
          view_more: config["business_more_ch"],
        };
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-start justify-between mb-12">
          ...
          >
            ...
            >
              {renderTitleAndSubTitle()?.view_more}
              <svg
